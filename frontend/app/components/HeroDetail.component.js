System.register(['angular2/core', "angular2/router", 'angular2/common', '../services/HeroService.service', '../services/UserService.service', './HeroDetailFavorites.component', '../directives/bargraph.directive', '../directives/circles.directive'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, common_1, HeroService_service_1, UserService_service_1, router_2, HeroDetailFavorites_component_1, bargraph_directive_1, circles_directive_1;
    var HeroDetail;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (circles_directive_1_1) {
                circles_directive_1 = circles_directive_1_1;
            }],
        execute: function() {
            HeroDetail = (function () {
                ...
                HeroDetail = __decorate([
                    core_1.Component({
                        ...
                        directives: [router_2.ROUTER_DIRECTIVES, common_1.CORE_DIRECTIVES, HeroDetailFavorites_component_1.HeroFans, bargraph_directive_1.Bargraph, circles_directive_1.Circles],
